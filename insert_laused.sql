...
INSERT INTO tootaja(tootaja_kood, e_mail, eesnimi, isikukood, parool, perenimi) VALUES (1, 'hans@mets.ee', 'Hans', '38503053399', public.crypt('parool1', public.gen_salt('bf', 11)), 'Mets');
INSERT INTO tootaja(tootaja_kood, e_mail, eesnimi, isikukood, parool, perenimi) VALUES (2, 'jaan@koer.ee', 'Jaan', '38404053539', public.crypt('parool2', public.gen_salt('bf', 11)), 'Koer');
INSERT INTO tootaja(tootaja_kood, e_mail, eesnimi, isikukood, parool, perenimi) VALUES (3, 'nele@keel.ee', 'Nele', '49011124567', public.crypt('parool3', public.gen_salt('bf', 11)), 'Keel');
INSERT INTO tootaja(tootaja_kood, e_mail, eesnimi, isikukood, parool, perenimi) VALUES (4, 'ingrid@leht.ee', 'Ingrid', '48503058475', public.crypt('parool4', public.gen_salt('bf', 11)), 'Leht');
INSERT INTO tootaja(tootaja_kood, e_mail, eesnimi, isikukood, parool, perenimi) VALUES (5, 'jaanus@paber.ee', 'Jaanus', '38803084390', public.crypt('parool5', public.gen_salt('bf', 11)), 'Paber');
