...
/*  Created On : 12-nov-2015 15:36:00 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

USE DATABASE garaazh
;
...
(
	"tootaja_kood" serial NOT NULL DEFAULT nextval(('"garaazh"."tootaja_tootaja_kood_seq"'::text)::regclass),
...
(
	...
	CONSTRAINT "CHK_organisatsiooni_tyybi_nimetus_pole_tyhi" CHECK (organisatsiooni_tyybi_nimetus !~ '^\s*$')
)
;

CREATE TABLE "garaazh"."organisatsioon"
(
	"organisatsiooni_kood" serial NOT NULL DEFAULT nextval(('"garaazh"."organisatsioon_organisatsiooni_kood_seq"'::text)::regclass),
	...
	CONSTRAINT "FK_organisatsiooni_tyyp" FOREIGN KEY () REFERENCES  () ON DELETE Cascade ON UPDATE Cascade
)
;
