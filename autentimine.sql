CREATE OR REPLACE FUNCTION on_kaupade_haldaja(text, text)
RETURNS boolean AS $$
DECLARE
rslt boolean;
BEGIN
...
COMMENT ON FUNCTION on_kaupade_haldaja(text, text) IS '(OP1.1) Selle funktsiooni abil autenditakse kaupade haldaja. Funktsiooni 
